...
export default function WorkspacePage({ section }: { section: 'graphics' | 'branding' }) {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden" style={{ background: '#0a0b0d' }}>
      ...
      {/* ── Graphics toolbar (fixed strip, only for graphics section) ── */}
      {section === 'graphics' && (
        <div
          className="shrink-0 flex items-center gap-[8px] px-[28px] py-[10px]"
          style={{ borderBottom: '1px solid rgba(255,255,255,0.06)', background: '#0a0b0d' }}
        >
